...
def conv_block(x, stage, branch, nb_filter, dropout_rate=None, weight_decay=0):
    ...
    x = Conv2D(inter_channel, (1, 1), name=conv_name_base+'_x1',kernel_initializer='he_normal',activation = 'relu')(x)
    ...
    x = Conv2D(nb_filter, (3, 3), name=conv_name_base+'_x2',kernel_initializer='he_normal',activation = 'relu')(x)
